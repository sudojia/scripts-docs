...
如果你想要脚本执行后进行消息推送，那么任选一种或多种方式进行配置
...
|  `TG_BOT_TOKEN`   |                        Telegram 推送                         | 非必须 | `TG_BOT_TOKEN` 和 `TG_USER_ID` 两者必需填写自己申请 [@BotFather](https://t.me/BotFather)的 Token如 `10xxx4:AAFcqxxxxgER5uw` |
|   `TG_USER_ID`    |                        Telegram 推送                         | 非必须 | `TG_BOT_TOKEN` 和 `TG_USER_ID` 两者必需私聊它 [@userinfobot](https://t.me/userinfobot) 随便发点什么即可获取到自己的 ID |
...
| `WXPUSHER_TOKEN`  |                     WxPusher微信推送服务                     | 非必须 | apptoken、[参考文档](https://wxpusher.zjiecode.com/docs/#/?id=%e8%8e%b7%e5%8f%96apptoken) |
|  `WXPUSHER_UID`   |                     WxPusher微信推送服务                     | 非必须 | uid、[参考文档](https://wxpusher.zjiecode.com/docs/#/?id=%e8%8e%b7%e5%8f%96uid) |
